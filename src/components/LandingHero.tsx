  ...
  return (
    <div className="text-center mb-8 sm:mb-12 animate-slide-up px-2">
      ...
      <div className="flex items-center justify-center gap-4 mb-4 sm:mb-6">
        <div className="relative">
          ...
          <div className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-primary via-primary to-accent flex items-center justify-center shadow-lg shadow-primary/40">
            <Eye className="w-8 h-8 sm:w-10 sm:h-10 text-primary-foreground blink-animation" />
            <div className="absolute -top-2 -right-2 w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-accent flex items-center justify-center animate-blink-fade">
              <EyeOff className="w-3 h-3 sm:w-4 sm:h-4 text-accent-foreground" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center gap-2 mb-4 sm:mb-6">
        <Eye className="w-4 h-4 sm:w-5 sm:h-5 text-primary blink-animation" />
        <p className="text-base sm:text-lg md:text-xl text-foreground font-semibold">
          Blink. Chat. <span className="text-primary">Gone.</span>
        </p>
        <Timer className="w-4 h-4 sm:w-5 sm:h-5 text-accent animate-blink-fade" />
      </div>
      
      {/* Description */}
      <p className="text-sm sm:text-base text-muted-foreground max-w-lg mx-auto leading-relaxed font-body px-4">
        Instant ephemeral messaging. No accounts, no traces—just quick, 
        private chats that vanish in a blink. Share a code, start talking.
      </p>
    </div>
  );
};
